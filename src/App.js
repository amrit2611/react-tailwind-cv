...
function App() {
  return (
    <>
      ...
      <button className="fixed hover:text-white hover:bg-blue-500 border-blue-500 border-4 border-solid rounded-xl bottom-5 right-10 px-4 py-1 ">Next Page</button>
    </>
  );
}
